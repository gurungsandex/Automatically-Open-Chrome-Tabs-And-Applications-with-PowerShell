...
- Opnens in Incognito mode.
- Detects if Chrome is already running and lets you close, skip, or cancel the script.
- Prompts you to select a Chrome profile before opening tabs.
- Opens all URLs in Incognito mode and launches other apps.
